...
public class SimplifyModelStage extends MusicStage {
    ...
    public SimplifyModelStage(MainApp mainApp, Image logoImage, String appName, Paint paint) {
        ...
        this.diyStage(true, 0, 0, mainHbox);
        this.setX(screenBounds.getWidth() - mainHbox.getPrefWidth() - 30);
        this.addDragEvent();
        this.getScene().getStylesheets().add(getClass().getResource("/css/main.css").toExternalForm());
        this.setTitle(appName);
        mainApp.getSimplifyTableView().setPrefWidth(mainHbox.getPrefWidth() - 20);
    }
    ...
    private Node initRightPane() {
        ...
        //4.右侧的关闭按钮
        Region closeRegion = playSvg.getCloseRegion(15.0, BLACK);
        ...
        unFoldButton.setOnAction(event -> {
            jfxPopup.show(unFoldButton, JFXPopup.PopupVPosition.TOP, JFXPopup.PopupHPosition.RIGHT, 0, 40);
        });
